...
@ValueListFieldType({
  getValues: () => [
    ...
    new Genre('F14', 'Fic: Commercial'),
    new Genre('F15', 'Fic: Family'),
    new Genre('F16', 'Fic: LGBTQ+'),
    new Genre('F17', 'Fic: Graphic Novel'),
    new Genre('F18', 'Fic: Picture Book'),
    new Genre('F19', 'Fic: Short Story'),
